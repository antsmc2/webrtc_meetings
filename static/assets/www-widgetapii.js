...
var eb=/#|$/;var fb=m("yt.dom.getNextId_");if(!fb){fb=function(){return++gb};
v("yt.dom.getNextId_",fb);var gb=0};var J=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};v("yt.config_",J);v("yt.tokens_",window.yt&&window.yt.tokens_||{});var hb=window.yt&&window.yt.msgs_||m("window.ytcfg.msgs")||{};v("yt.msgs_",hb);function ib(a){var b=arguments;if(1<b.length){var c=b[0];J[c]=b[1]}else for(c in b=b[0],b)J[c]=b[c]}
function jb(a){"function"==p(a)&&(a=kb(a));return window.setInterval(a,250)}
function kb(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){throw lb(b),b;}}:a}
function lb(a,b){var c=m("yt.logging.errors.log");c?c(a,b,void 0,void 0,void 0):(c=[],c="ERRORS"in J?J.ERRORS:c,c.push([a,b,void 0,void 0,void 0]),ib("ERRORS",c))}
;function K(a){this.type="";this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.shiftKey=this.ctrlKey=this.altKey=!1;this.clientY=this.clientX=0;if(a=a||window.event){this.a=a;for(var b in a)b in mb||(this[b]=a[b]);(b=a.target||a.srcElement)&&3==b.nodeType&&(b=b.parentNode);this.target=b;if(b=a.relatedTarget)try{b=b.nodeName?b:null}catch(c){b=null}else"mouseover"==this.type?b=a.fromElement:"mouseout"==this.type&&(b=a.toElement);this.relatedTarget=
...
f=kb(f);a.addEventListener?("mouseenter"==b&&e?b="mouseover":"mouseleave"==b&&e?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),a.addEventListener(b,f,!1)):a.attachEvent("on"+b,f);A[d]=[a,b,c,f,!1]}}}
...
function wb(a){var b=z(document.getElementsByTagName("yt:"+a));a="yt-"+a;var c=document;a=c.querySelectorAll&&c.querySelector?c.querySelectorAll("."+a):Ka(a);a=z(a);return qa(b,a)}
...
function zb(a){Cb(a.b,a,a.g);a.c=jb(u(a.H,a));pb(a.a,"load",u(function(){window.clearInterval(this.c);this.c=jb(u(this.H,this))},a))}
